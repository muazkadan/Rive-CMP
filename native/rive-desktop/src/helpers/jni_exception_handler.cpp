...
namespace rive_desktop {
    /* static  */
    std::string JNIExceptionHandler::get_exception_message(
        JNIEnv *env,
    ...
    /* static  */
    void JNIExceptionHandler::append_throwable_message(
        JNIEnv *env,
    ...
    /* static  */
    void JNIExceptionHandler::append_stack_trace(
        JNIEnv *env,
        jthrowable throwable,
        jmethodID midGetStackTrace,
        std::ostringstream &errorMsg) {
    ...
    /* static  */
    void JNIExceptionHandler::check_and_rethrow(JNIEnv *env) {
    ...
    /* static  */
    bool JNIExceptionHandler::ClearAndLogErrors(JNIEnv *env,
                                                const char *tag,
                                                const char *message) {
        if (!env->ExceptionCheck()) {
            return false;
    ...
    /* static  */
    jobject JNIExceptionHandler::CallObjectMethod(JNIEnv *env,
                                                  jobject obj,
                                                  jmethodID methodID,
                                                  ...) {
        va_list args;
    ...
    /* static  */
    void JNIExceptionHandler::CallVoidMethod(JNIEnv *env,
                                             jobject obj,
                                             jmethodID methodID,
                                             ...) {
        va_list args;
    ...
    /* static  */
    jint JNIExceptionHandler::CallIntMethod(JNIEnv *env,
                                            jobject obj,
                                            jmethodID methodID,
                                            ...) {
        va_list args;
    ...
    /* static  */
    jboolean JNIExceptionHandler::CallBooleanMethod(
        JNIEnv *env,
        jobject obj,
        jmethodID methodID,
        ...) {
    ...
    /* static  */
    jobject JNIExceptionHandler::CallStaticObjectMethod(
        JNIEnv *env,
        jclass clazz,
        jmethodID methodID,
        ...) {
